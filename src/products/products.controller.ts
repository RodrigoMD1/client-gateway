...
import { NATS_SERVICE } from 'src/config/index';
...
export class ProductsController {
  ...
  constructor(
    @Inject(NATS_SERVICE) private readonly Client: ClientProxy // esto me permite usar los controller y la logica del products del otro proyecto
  ) { }
  ...
  findAllProducts(@Query() paginationDto: PaginationDto) {
    return this.Client.send({ cmd: 'find_all_products' }, paginationDto) // el segundo argumento ese {} vacio seria el payload del otro proyecto pero aca se envia un objeto vacio
  }
